...
The technical name of this module is *freeswitch_click2dial*, but this module implements much more than a simple *click2dial* ! This module adds 3 functionalities:
...
1) It adds a *Dial* button in the partner form view so that users can directly dial a phone number through FreeSWITCH. This feature is usually known as *click2dial*. Here is how it works :
    ...
    * OpenERP connects to the FreeSWITCH Event Socket and FreeSWITCH makes the user's phone ring.
...
3) It adds a phone icon (*Open Caller*) in the top menu bar (next to the Preferences) to get the partner/lead/candidate/registrations corresponding to the calling party in one click. Here is how it works :
    ...
    * When the user clicks on the phone icon, OpenERP sends a query to the FreeSWITCH Event Socket to get a list of the current phone calls
