...
# To test this script manually (i.e. outside of FreeSWITCH), run :
...
PATH=/usr/local/sbin:/usr/local/bin:/var/lib/freeswitch/agi-bin:/sbin:/bin:/usr/sbin:/usr/bin:/usr/share/freeswitch/agi-bin

timeout 2s set_name_agi.py --server openerp.mycompany.com --database erp_prod --user-id 12 --password "thepasswd" --geoloc --geoloc-country "US" --geoloc-lang "en" --notify "1"
