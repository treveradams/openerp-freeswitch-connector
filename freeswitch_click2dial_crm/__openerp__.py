...
This module adds CRM-specific features to the freeswitch_click2dial module.
...
A detailed documentation for the OpenERP-FreeSWITCH connector is available on the Akretion Web site : http://www.akretion.com/en/products-and-services/openerp-freeswitch-voip-connector
""",
    "depends": [
